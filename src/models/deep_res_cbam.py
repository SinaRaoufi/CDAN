...
class LLIE(nn.Module):
    def __init__(self):
        ...
        self.encoder_residual2 = ResidualBlock(64)
        ...
        self.encoder_residual3 = ResidualBlock(128)
        self.encoder_residual4 = ResidualBlock(128)
        ...
        self.encoder_residual5 = ResidualBlock(256)
        self.encoder_residual6 = ResidualBlock(256)
        ...
        self.encoder_residual7 = ResidualBlock(512)
        self.encoder_residual8 = ResidualBlock(512)
    ...
    def forward(self, x):
        ...
        out = self.encoder_residual5(out)
        out = self.encoder_residual6(out)
        ...
        out = self.encoder_residual7(out)
        out = self.encoder_residual8(out)
